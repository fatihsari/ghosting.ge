...
<li>
    <a id="Menu-gHosting" href="#" title="gHosting"><span class="hidden-xs">gHosting</span><span class="visible-xs"><i class="fa fa-user"></i></span></a>
    <ul>
        <li><a id="Menu-gHosting-View_Containers" href="containers.php?view=containers">Containers</a></li>
        <li><a id="Menu-gHosting-View_Domains" href="containers.php?view=domains">Domains</a></li>
        <li><a id="Menu-gHosting-View_Domains" href="tbc_transactions.php">Transactions</a></li>
    </ul>
</li>   
