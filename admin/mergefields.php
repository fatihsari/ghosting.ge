        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    if( $type == "product" ) 
                    {
                        echo "<b>Container params</b>";
                        echo "<br /><table><tr><td width=\"150\"><a href=\"#\" onclick=\"insertMergeField('container_id');return false\">Container ID</a></td><td>{\$container_id}</td></tr>";
                        echo "<tr><td><a href=\"#\" onclick=\"insertMergeField('ssh_port');return false\">SSH Port</a></td><td>{\$ssh_port}</td></tr>";
                        echo "<tr><td><a href=\"#\" onclick=\"insertMergeField('sftp_port');return false\">SFTP Port</a></td><td>{\$sftp_port}</td></tr>";
                        echo "<tr><td><a href=\"#\" onclick=\"insertMergeField('rmysql_port');return false\">RMYSQL_Port</a></td><td>{\$rmysql_port}</td></tr></table><br />";
