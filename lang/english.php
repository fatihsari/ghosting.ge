...
$_LANG['kbsuggestions'] = "Support Suggestions";
$_LANG['knowledgebaserelatedarticles'] = "Related Articles";
$_LANG['knowledgebaseserachplaceholder'] = "What can we help you with?";
$_LANG['kbsuggestionsexplanation'] = "The following articles were found in the support which may answer your question. Please review the suggestions before submission.";
...
$_LANG['knowledgebaseintrotext'] = "The support is organized into different categories. Either choose a category from below or search the support for the answer to your question.";
...
$_LANG['knowledgebasetitle'] = "Support";
...
$_LANG['supportticketsheader'] = "If you can't find a solution to your problems in our support, you can submit a ticket by selecting the appropriate department below.";
...
$_LANG['clientHomeSearchKb'] = "Enter a question here to search our help for answers...";
...
$_LANG['ghosting']['nav']['nav'] = 'Navigation';
$_LANG['ghosting']['nav']['main'] = 'Main';
$_LANG['ghosting']['nav']['webhosting'] = 'WEB hosting';
$_LANG['ghosting']['nav']['vps'] = 'VPS server';
$_LANG['ghosting']['nav']['db'] = 'Database';
$_LANG['ghosting']['nav']['service'] = 'Professional hosting';
$_LANG['ghosting']['nav']['about'] = 'About us';
$_LANG['ghosting']['nav']['contact'] = 'Contact';

$_LANG['ghosting']['slider']['1'] = 'Host your sites on GOOGLE servers.';
$_LANG['ghosting']['slider']['2'] = 'The best hosting for your sites.';
$_LANG['ghosting']['slider']['3'] = 'High speed.';
$_LANG['ghosting']['slider']['4'] = 'Safety is always important.';



$_LANG['ghosting']['advantages']['0'] = 'Benefits';
$_LANG['ghosting']['advantages']['1'] = '99% Uptime';
$_LANG['ghosting']['advantages']['1_desc'] = 'Server shutdown can occur on rare occasions, for example, when a software update is required.';
$_LANG['ghosting']['advantages']['2'] = 'Simple control system';
$_LANG['ghosting']['advantages']['2_desc'] = 'Your server can be managed from your own control panel.';
$_LANG['ghosting']['advantages']['3'] = 'High speed';
$_LANG['ghosting']['advantages']['3_desc'] = 'Our service uses GOOGLE servers, which ensures high server speed.';
$_LANG['ghosting']['advantages']['4'] = 'безопасност';
$_LANG['ghosting']['advantages']['4_desc'] = 'Our service uses GOOGLE servers, which ensures a high level of security.';
$_LANG['ghosting']['advantages']['5'] = '7/24 Support';
$_LANG['ghosting']['advantages']['5_desc'] = 'You can contact us for any problem and we will help you as soon as possible.';

$_LANG['ghosting']['text']['not_registered'] = 'Not registered yet?';
$_LANG['ghosting']['text']['register'] = 'Registration';
$_LANG['ghosting']['text']['registered'] = 'Already registered?';
$_LANG['ghosting']['text']['login'] = 'Login';
$_LANG['ghosting']['text']['company_address'] = ' Tbilisi, Shota Nadirashvili #42';
$_LANG['ghosting']['text']['terms'] = 'Terms and Conditions';
$_LANG['ghosting']['text']['policy'] = 'Privacy Policy';
$_LANG['ghosting']['text']['contract'] = 'Agreement';
$_LANG['ghosting']['text']['about'] = 'About us';
$_LANG['ghosting']['text']['about_desc'] = 'gHosting.ge - offers professional hosting services for your sites, for which the company uses official GOOGLE servers all over the world. <br> Our company also offers professional services for setting up and administering servers. <br> <br> GOOGLE servers are stable and high speed of work, and our specialists are constantly ready,
To help you solve your problems as soon as possible. <br> When you trust us with your projects, you never have to worry about the stable operation of your project.
So why risk your business by trusting someone else?';

$_LANG['ghosting']['text']['choose_services'] = 'Select the desired service';
$_LANG['ghosting']['text']['our_services'] = 'Our services';

$_LANG['ghosting']['text']['web_hosting'] = 'WEB hosting';
$_LANG['ghosting']['text']['web_hosting_desc'] = 'Each hosting account is hosted on an isolated virtual server that can be managed using a dedicated control panel. The server can also be managed via an SSH client (with root user privileges).';
$_LANG['ghosting']['text']['vps_hosting'] = 'VPS server';
$_LANG['ghosting']['text']['vps_hosting_desc'] = 'On the VPS server, you can install any software and fully manage the server.';
$_LANG['ghosting']['text']['db'] = 'Database';
$_LANG['ghosting']['text']['db_desc'] = 'If your site uses a large volume of MSSQL, MYSQL or Postgresql databases, this may cause the site to crash due to the seizure of a large portion of the resources to the database servers. Use a database customized and optimized by Google.';
$_LANG['ghosting']['text']['pro_hosting'] = 'Professional hosting';
$_LANG['ghosting']['text']['pro_hosting_desc'] = 'If your site serves a large number of visitors and requires special server services, our company offers professional services for setting up and administering servers.';

$_LANG['ghosting']['text']['pro_service']['title'] = 'Professional hosting';
$_LANG['ghosting']['text']['pro_service']['desc'] = 'If your site serves a large number of visitors and requires special server services, our company offers professional services for setting up and administering the server.

<h2> How customer traffic affects your business. </h2>
...
<ul>
  <li> Can you broadcast live? </li>
  <li> Can you distribute media content? </li>
</ul>
Not to worry about site downtime or (you haven\'t thought about it at all) about a complete server failure? <br>
One way to make sure your site is ready to meet all of your requirements is to "load balance" between different servers. Load Balancing uses different algorithms to distribute traffic evenly across different servers, ensuring optimal site performance. <br> <br>

The cost of the service is determined depending on the work performed. <br>
For more information <a href="/contact.php"> Contact us. </a>';

$_LANG['ghosting']['text']['about_us']['title'] = 'About us';
$_LANG['ghosting']['text']['about_us']['desc'] = 'gHosting.ge - offers professional hosting services for your sites, for which the company uses official GOOGLE servers all over the world. <br> Our company also offers professional services for setting up and administering servers. <br> <br> GOOGLE servers are stable and high speed of work, and our specialists are constantly ready,
To help you solve your problems as soon as possible. <br> When you trust us with your projects, you never have to worry about the stable operation of your project.
So why risk your business by trusting someone else?
<h2> Services </h2>
<ul>
<li>
    <a href="[seo_web_hosting_url]"> <b> WEB Hosting </b> </a> - Each hosting account is hosted on an isolated virtual server that can be managed using a dedicated control panel. The server can also be managed via an SSH client (with root user privileges), which allows you to install any software on the server according to your requirements.
</li>
<li style = "margin-top: 10px;">
    <a href="[seo_vps_servers_url]"> <b> VPS server </b> </a> - You can install any software on a VPS server and fully manage the server.
</li>
<li style = "margin-top: 10px;">
    <a href="[seo_databases_url]"> <b> Databases </b> </a> - If your site uses a large volume of MSSQL, MYSQL or Postgresql databases, this may cause the site to crash due to the seizure of a large part of the resources to the database servers. Use a database customized and optimized by Google.
</li>
<li style = "margin-top: 10px;">
    <a href="[seo_profesional_service_url]"> <b> Professional hosting </b> </a> - If your site serves a large number of visitors and requires special server services, our company offers professional services for configuring and administering servers.
</li>
</ul>';

$_LANG['ghosting']['options']['CPU'] = 'Processor power';
$_LANG['ghosting']['options']['RAM'] = 'RAM';
$_LANG['ghosting']['options']['HDD'] = 'Disk capacity';
$_LANG['ghosting']['options']['Personal IP Address'] = 'Personal IP address';
$_LANG['ghosting']['options']['OS'] = 'Operating system';
$_LANG['ghosting']['options']['GPU'] = 'Graphic card';
$_LANG['ghosting']['options']['GPU Count'] = 'Number of graphics cards';
$_LANG['ghosting']['options']['DB'] = 'Database';

$_LANG['ghosting']['gateways']['Invoice'] = 'Invoice';
$_LANG['ghosting']['gateways']['Visa'] = 'Visa / Mastercard';

$_LANG['ghosting']['gateways']['pay'] = 'Pay';
$_LANG['ghosting']['gateways']['redirecting'] = 'Forwarding ...';
$_LANG['ghosting']['gateways']['redirecting2'] = 'Wait, there is an automatic redirection to the checkout page ...';
$_LANG['ghosting']['gateways']['redirecting3'] = 'If automatic redirection fails within one minute, click the next button';
$_LANG['ghosting']['gateways']['redirecting4'] = 'Go to payment page';
$_LANG['ghosting']['control_panel'] = 'Control panel';

$_LANG['ghosting']['reboot']['label'] = 'Reboot';
$_LANG['ghosting']['reboot']['confirm'] = 'Do you really want to restart the server?';
$_LANG['ghosting']['reboot']['yes'] = 'Yes';
$_LANG['ghosting']['reboot']['no'] = 'No';
