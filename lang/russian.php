...
$_LANG['globalsystemname'] = "Главная";
...
$_LANG['knowledgebaserelatedarticles'] = "Статьи по Теме";
$_LANG['knowledgebaseserachplaceholder'] = "Чем мы можем вам помочь?";
...
$_LANG['knowledgebaseintrotext'] = "Поддержка разделена на разные категории. Вы можете найти ответы на вопросы, выбрав категорию, или воспользоваться поиском.";
...
$_LANG['knowledgebasetitle'] = "Поддержка";
...
$_LANG['orderpaymenttermbiennially'] = "каждые два года";
...
$_LANG['orderpaymenttermtriennially'] = "Каждые три года";
...
$_LANG['ghosting']['nav']['nav'] = 'Навигация';
$_LANG['ghosting']['nav']['main'] = 'Главная';
$_LANG['ghosting']['nav']['webhosting'] = 'Веб хостинг';
$_LANG['ghosting']['nav']['vps'] = 'VPS сервера';
$_LANG['ghosting']['nav']['db'] = 'Базы данных';
$_LANG['ghosting']['nav']['service'] = 'Профессиональный хостинг';
$_LANG['ghosting']['nav']['about'] = 'О компании';
$_LANG['ghosting']['nav']['contact'] = 'Контакт';

$_LANG['ghosting']['slider']['1'] = 'Разместите свои сайты на серверах GOOGLE.';
$_LANG['ghosting']['slider']['2'] = 'Лучший хостинг для ваших сайтов.';
$_LANG['ghosting']['slider']['3'] = 'Высокая скорость.';
$_LANG['ghosting']['slider']['4'] = 'Безопасность всегда важна.';



$_LANG['ghosting']['advantages']['0'] = 'Преимущества';
$_LANG['ghosting']['advantages']['1'] = '99% Uptime';
$_LANG['ghosting']['advantages']['1_desc'] = 'Отключение сервера может происходить в редких случаях, например, когда требуется обновление программного обеспечения.';
$_LANG['ghosting']['advantages']['2'] = 'Простая система управления';
$_LANG['ghosting']['advantages']['2_desc'] = 'Вашим сервером можно управлять из вашей собственной панели управления.';
$_LANG['ghosting']['advantages']['3'] = 'Высокая скорость';
$_LANG['ghosting']['advantages']['3_desc'] = 'Наш сервис использует серверы GOOGLE, что обеспечивает высокую скорость работы сервера.';
$_LANG['ghosting']['advantages']['4'] = 'безопасност';
$_LANG['ghosting']['advantages']['4_desc'] = 'Наш сервис использует серверы GOOGLE, что обеспечивает высокий уровень безопасности.';
$_LANG['ghosting']['advantages']['5'] = '7/24 Поддержка';
$_LANG['ghosting']['advantages']['5_desc'] = 'Вы можете связаться с нами по любой проблеме, и мы поможем вам в кратчайшие сроки.';

$_LANG['ghosting']['text']['not_registered'] = 'Еще не зарегистрированы?';
$_LANG['ghosting']['text']['register'] = 'Регистрация';
$_LANG['ghosting']['text']['registered'] = 'Уже зарегистрированы?';
$_LANG['ghosting']['text']['login'] = 'Авторизация';
$_LANG['ghosting']['text']['company_address'] = ' Тбилиси, Ш. Надирашвили #42';
$_LANG['ghosting']['text']['terms'] = 'Положения и условия';
$_LANG['ghosting']['text']['policy'] = 'Политика конфиденциальности';
$_LANG['ghosting']['text']['contract'] = 'Соглашение';
$_LANG['ghosting']['text']['about'] = 'О компании';
$_LANG['ghosting']['text']['about_desc'] = 'gHosting.ge - предлагает профессиональные услуги хостинга для ваших сайтов, для чего компания использует официальные серверы GOOGLE по всему миру.<br>Наша компания также предлагает профессиональные услуги по настройке и администрированию серверов.<br><br>Сервера GOOGLE отличаются стабильностью и высокой скоростью работы, а наши специалисты постоянно готовы,
Чтобы помочь вам решить ваши проблемы в кратчайшие сроки.<br>Когда вы доверяете нам свои проекты, вам никогда не придется беспокоиться о стабильной работе вашего проекта.
Так зачем рисковать своим бизнесом, доверяя кому-то другому?';

$_LANG['ghosting']['text']['choose_services'] = 'Выберите желаемую услугу';
$_LANG['ghosting']['text']['our_services'] = 'Наши услуги';

$_LANG['ghosting']['text']['web_hosting'] = 'Веб хостинг';
$_LANG['ghosting']['text']['web_hosting_desc'] = 'Каждая учетная запись хостинга размещается на изолированном виртуальном сервере, которым можно управлять с помощью специальной панели управления. Сервером также можно управлять через SSH-клиент (с привилегями  root пользователя).';
$_LANG['ghosting']['text']['vps_hosting'] = 'VPS сервера';
$_LANG['ghosting']['text']['vps_hosting_desc'] = 'На VPS сервере можно установить любое программное обеспечение и полностью управлять сервером.';
$_LANG['ghosting']['text']['db'] = 'Базы данных';
$_LANG['ghosting']['text']['db_desc'] = 'Если ваш сайт использует большой объем баз данных MSSQL, MYSQL или Postgresql, это может вызвать сбой в работе сайта из-за захвата большой части ресурсов серверам базой данных. Используйте базу данных, настроенную и оптимизированную специалистами Google.';
$_LANG['ghosting']['text']['pro_hosting'] = 'Профессиональный хостинг';
$_LANG['ghosting']['text']['pro_hosting_desc'] = 'Если ваш сайт обслуживает большое количество посетителей и требует специальных серверных услуг, наша компания предлагает профессиональные услуги по настройке и администрированию серверов.';

$_LANG['ghosting']['text']['pro_service']['title'] = 'Профессиональный хостинг';
$_LANG['ghosting']['text']['pro_service']['desc'] = 'Если ваш сайт обслуживает большое количество посетителей и требует специальных серверных услуг, наша компания предлагает профессиональные услуги по настройке и администрированию сервера.

<h2>Как трафик клиентов влияет на ваш бизнес.</h2>
Вы хотите, чтобы ваша компания была популярной и модной. Сегодня это часть ведения бизнеса.
<br><br>
Однако наличие трендов означает трафик, а трафик означает большой трафик на ваш сайт.
<br><br>
Сможет ли ваш сайт выдержать рост числа пользователей в результате вашей маркетинговой кампании?
<ul>
  <li>Сможете ли вы вести прямой трансляции?</li>
  <li>Сможете ли вы распространять медиаконтент?</li>
</ul>
Чтобы не беспокоиться о простоях сайта или (вы вообще об этом не задумывались) о полном отказе сервера?<br>
Один из способов убедиться, что ваш сайт готов удовлетворить все ваши требования, - это «сбалансировать нагрузку» между различными серверами. «Балансировка нагрузки» использует разные алгоритмы для равномерного распределения трафика между разными серверами, обеспечивая оптимальную производительность сайта.<br><br>

Стоимость услуги определяется в зависимости от выполняемой работы.<br>
Чтобы получить больше информации <a href="/contact.php">Связаться с нами.</a>';

$_LANG['ghosting']['text']['about_us']['title'] = 'О компании';
$_LANG['ghosting']['text']['about_us']['desc'] = 'gHosting.ge - предлагает профессиональные услуги хостинга для ваших сайтов, для чего компания использует официальные серверы GOOGLE по всему миру.<br>Наша компания также предлагает профессиональные услуги по настройке и администрированию серверов.<br><br>Сервера GOOGLE отличаются стабильностью и высокой скоростью работы, а наши специалисты постоянно готовы,
Чтобы помочь вам решить ваши проблемы в кратчайшие сроки.<br>Когда вы доверяете нам свои проекты, вам никогда не придется беспокоиться о стабильной работе вашего проекта.
Так зачем рисковать своим бизнесом, доверяя кому-то другому?
<h2>Сервисы</h2>
<ul>
<li>
    <a href="[seo_web_hosting_url]"><b>Веб хостинг</b></a> - Каждая учетная запись хостинга размещается на изолированном виртуальном сервере, которым можно управлять с помощью специальной панели управления. Сервером также можно управлять через SSH-клиент (с привилегиами  root пользователя), что позволяет устанавливать на сервер любое программное обеспечение в соответствии с вашими требованиями.
</li>
<li style="margin-top: 10px;">
    <a href="[seo_vps_servers_url]"><b>VPS сервера</b></a> - На VPS сервере можно установить любое программное обеспечение и полностью управлять сервером.
</li>
<li style="margin-top: 10px;">
    <a href="[seo_databases_url]"><b>Базы данных</b></a> - Если ваш сайт использует большой объем баз данных MSSQL, MYSQL или Postgresql, это может вызвать сбой в работе сайта из-за захвата большой части ресурсов серверам базой данных. Используйте базу данных, настроенную и оптимизированную специалистами Google.
</li>
<li style="margin-top: 10px;">
    <a href="[seo_profesional_service_url]"><b>Профессиональный хостинг</b></a> - Если ваш сайт обслуживает большое количество посетителей и требует специальных серверных услуг, наша компания предлагает профессиональные услуги по настройке и администрированию серверов.
</li>
</ul>';


$_LANG['ghosting']['options']['CPU'] = 'Мощность процессора';
$_LANG['ghosting']['options']['RAM'] = 'Оперативная память';
$_LANG['ghosting']['options']['HDD'] = 'Емкость диска';
$_LANG['ghosting']['options']['Personal IP Address'] = 'Персональный IP-адрес';
$_LANG['ghosting']['options']['OS'] = 'Операционная система';
$_LANG['ghosting']['options']['GPU'] = 'Графическая карта';
$_LANG['ghosting']['options']['GPU Count'] = 'Количество графических карт';
$_LANG['ghosting']['options']['DB'] = 'База данных';
$_LANG['ghosting']['gateways']['Invoice'] = 'Выставить счет (инвойс)';
$_LANG['ghosting']['gateways']['PayPal'] = 'Visa / Mastercard';

$_LANG['ghosting']['gateways']['pay'] = 'Оплатить';
$_LANG['ghosting']['gateways']['redirecting'] = 'Переадресация...';
$_LANG['ghosting']['gateways']['redirecting2'] = 'Подождите, происходит автоматическое перенаправление на страницу оплаты ...';
$_LANG['ghosting']['gateways']['redirecting3'] = 'Если автоматическое перенаправление не удается в течение одной минуты, нажмите следующую кнопку';
$_LANG['ghosting']['gateways']['redirecting4'] = 'Перейти на страницу оплаты';
$_LANG['ghosting']['control_panel'] = 'Панель управления';

$_LANG['ghosting']['reboot']['label'] = 'перезапустить';
$_LANG['ghosting']['reboot']['confirm'] = 'Вы действительно хотите перезапустить сервер?';
$_LANG['ghosting']['reboot']['yes'] = 'Да';
$_LANG['ghosting']['reboot']['no'] = 'Нет';
