                ...
                <div class="col-md-12">
                    <div id="main-slider">
                        ...
                        <div class="slide info-slide2">
                            ...
                            <div class="big-title">High Speed.</div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="custom-plan-box">
                    <input id="c-plan" type="text" data-slider-min="1" data-slider-max="100" data-slider-step="1" data-slider-value="50" data-currency="$" data-unit="GB">
                </div>
            </div>
        </div>
    </div>
