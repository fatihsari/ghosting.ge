    ...
    <div class="row">
        ...
        <div class="form-holder">
            <div class="menu-holder">
                <ul class="main-links">
                    <li><a class="normal-link" href="{$WEB_ROOT}/login.php">{$LANG.ghosting.text.registered}</a></li>
                    <li><a class="sign-button" href="{$WEB_ROOT}/login.php">{$LANG.ghosting.text.login}</a></li>
                </ul>
            </div>
