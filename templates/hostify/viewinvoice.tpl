                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                {foreach from=$invoiceitems item=item}
                                    <tr>
                                        <td>
                                            {foreach from=$LANG.ghosting.options key=k item=v}
                                                {$item.description = $item.description|replace:$k:$v}
                                            {/foreach}
                                            {$item.description}
                                            {if $item.taxed eq "true"} *{/if}</td>
                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            {foreach from=$transactions item=transaction}
                                {foreach from=$LANG.ghosting.gateways key=k item=v}
                                   {$transaction.gateway = $transaction.gateway|replace:$k:$v}
                                {/foreach}
                                <tr>
