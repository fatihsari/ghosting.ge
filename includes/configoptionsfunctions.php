<?php 
function translateOptionName($optionname)
{
    global $_LANG;
    if(isset($_LANG['ghosting']['options'][$optionname]))
        return $_LANG['ghosting']['options'][$optionname];
    return $optionname;
}
function getCartConfigOptions($pid, $values, $cycle, $accountid = "", $orderform = "", $showHiddenOverride = false)
{
    ...
    $showhidden = ($showHiddenOverride || WHMCS\Session::get("adminid") && (defined("ADMINAREA") || $whmcs->isApiRequest()) ? true : false);
